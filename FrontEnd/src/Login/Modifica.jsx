...
function Modifica() {
    ...
    const onSubmit = (e) => {
        ...
        if (password !== password2) {
            react_toastify_1.toast.error('Parolele nu se potrivesc');
        }
        else {
            const userData = {
                password,
            };
            dispatch((0, authSlice_1.modifica)(userData));
        }
    };
    if (isLoading) {
...
exports.default = Modifica;
//# sourceMappingURL=Modifica.jsx.map