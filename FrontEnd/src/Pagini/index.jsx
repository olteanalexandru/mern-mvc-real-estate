 ...
 <div className="container border-colorat">
	...
	<div className="row ">
        ...
        <a href="/goals">
			...
			</h3><img src={require('../images/paris.jpg')} className=" rounded img-fluid img" alt="Paris"/>
		</div>
		<div className="col-md-4 text-center border-colorat " style={{ paddingBottom: '9rem' }}> <h3>
      <a href="/goals"> 
				Lorem ipsum dolor  amet. </a> </h3><img src={require('../images/newyork.jpg')} className=" rounded img-fluid img" alt="New York"/>
		</div>
		<div className="col-md-4 text-center ">
			<h3>
        <a href="/goals">
        Lorem  dolor sit amet. </a>
			</h3><img src={require('../images/sanfran.jpg')} className=" rounded img-fluid img" alt="San Francisco"/>
		</div>
	</div>
    </div>
  ...
  <p>
    <a className="btn btn-primary btn-large" href="/noutati.html">Learn more</a>
  </p>
    </div>
    </div>
    </div>
